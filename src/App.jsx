...
const bitKeep = () => ({
  ...
  getIcon: async () => `<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  getInterface: async () => {
    ...
    if (ethereumInjectionExists && window['ethereum'].isBitKeep) {
      ...
      window.open('https://bitkeep.com/en/download?type=0', '_blank')
      throw new Error(`Please Install <a href="https://bitkeep.com/en/download?type=0">BitKeep</a> to use this wallet`)
    }
